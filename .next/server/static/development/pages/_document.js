...
/*!*********************!*\
  !*** ./lib/auth.js ***!
  \*********************/
/*! exports provided: loginUser, getUserProfile, getServerSideToken, getClientSideToken, getUserScript, authInitialProps, logoutUser */
...
const getUserProfile = async (email, password) => {
  const {
    data
...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  ...
  static async getInitialProps(ctx) {
    ...
    return _objectSpread({}, props, {}, userData);
  }
